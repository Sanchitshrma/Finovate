    ...
    <div className="container py-5">
      <div className="row py-4 text-center g-4">
        ...
        <div className="col-6 col-lg-4 p-3 mt-3">
          <img src="media/images/goldenpiLogo.png" alt="zerodhaFundhouseLogo" className="img-fluid" />
        ...
        <div className="col-6 col-lg-4 p-3 mt-3">
          <img src="media/images/sensibullLogo.svg" alt="sensibullLogo" className="img-fluid" />
        ...
        <div className="col-6 col-lg-4 p-3 mt-3">
          <img src="media/images/tijori.svg" alt="smallcaselogo" className="img-fluid" />
